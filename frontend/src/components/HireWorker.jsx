...
export default function HireWorker({ worker, onClose, onHireSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axiosInstance.post("/employment", {
        requester: { username },
        employee: { username: worker.username },
        beginDate,
        finishDate,
      });
      ...
      setErrorMsg("Failed to hire worker. Please try again.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="bg-white rounded-2xl shadow-xl p-6 max-w-lg mx-auto">
      ...
      <div className="bg-gray-50 rounded-lg p-4 mb-6">
        <div className="grid grid-cols-1 gap-2 text-sm">
          ...
          <div><strong>Phone:</strong> {worker.phonenumber}</div>
