        ...
        <div>
            <section className="py-12 px-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                    ...
                    {(localStorage.getItem('isFarmer') === 'true' || localStorage.getItem('isWorker') === 'true')? <div onClick={() => navigate("/hiring")} className="cursor-pointer"><FeatureCard icon={<GiFarmer size={28} />} title="Employment" desc="Connect with local agricultural labourers easily." /></div>:<></>}          
