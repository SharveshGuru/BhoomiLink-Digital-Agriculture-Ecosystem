        ...
        <div>
            <section className="py-12 px-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                    ...
                    {localStorage.getItem('isFarmer') === 'true'? <div onClick={() => navigate("/rentals")} className="cursor-pointer"><FeatureCard icon={<FaTractor size={28} />} title="Equipment Rental" desc="Rent tractors and farming tools on demand." /></div>:<></>}
