              ...
              {rawMaterials.map((material) => (
                ...
                >
                  ...
                  <div className="p-3 sm:p-4">
                    <h3 className="text-base sm:text-lg font-semibold text-green-800 mb-1">{material.name}</h3>
                    <p className="text-xs sm:text-sm text-gray-600 mb-2">Category: {material.category}</p>
                    <div className="flex justify-between items-center mb-2 sm:mb-3">
                      <span className="text-xs sm:text-sm font-medium">₹{material.price.toFixed(2)}/unit</span>
                      <span
